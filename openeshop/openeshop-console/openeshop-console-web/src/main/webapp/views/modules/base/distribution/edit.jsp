                ...
                <div class="col-sm-12">
                    <section class="panel">
                        <header class="panel-heading">
                            <span><spring:message code="app.distribution.title" /></span>
                        </header>
                        <div class="panel-body">
                            <form class="data-form form-horizontal" role="form" method="POST" action="">
                                <input type="hidden" name="id" value="${PARAM.id}" />
                                <div class="form-group">
                                    <label for="name" class="col-lg-2 col-sm-2 control-label"><spring:message code="app.distribution.title.name" /></label>
                                ...
                                <div class="form-group">
                                    <label for="code" class="col-lg-2 col-sm-2 control-label"><spring:message code="app.distribution.title.code" /></label>
                                    <div class="col-lg-8 col-sm-8">
                                ...
                                <div class="form-group">
				                    <label class="col-lg-2 col-sm-2 control-label" for="config"><spring:message code="app.distribution.title.config" /></label>
				                    <div class="col-lg-8 col-sm-8">
        ...
        <script type="text/javascript">
	        $(function(){
	        	$('.action-cancel').click(function(){
	        		location.href = contextPath + '/distribution';
	        	});
	        	...
	        	$('.data-form').validate({
	        		submitHandler: function(f){
	        			$(f).ajaxSubmit({
	        				type: 'POST',
	        				url: '${contextPath}/distribution/edit/exec',
	        				success: function(r){
	        					if(r){
